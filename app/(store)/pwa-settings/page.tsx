  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-brand-espresso hover:text-brand-mauve mb-6 whitespace-nowrap"
        >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              {notificationPermission === 'granted' && (
                <div className="bg-brand-nude/30 border border-brand-nude/70 rounded-xl p-4">
                  <p className="text-sm text-brand-cocoa font-medium mb-2">You will receive notifications for:</p>
                  <ul className="space-y-1 text-sm text-brand-espresso">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-brand-nude/30 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-brand-espresso text-xl"></i>
                  <span className="font-semibold text-brand-cocoa">Fast Loading</span>
                </div>
                <p className="text-sm text-brand-cocoa">Instant page loads with smart caching</p>
              </div>
