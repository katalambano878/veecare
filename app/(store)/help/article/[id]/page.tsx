    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link
            href="/help"
            className="inline-flex items-center text-brand-espresso hover:text-brand-mauve font-semibold mb-6 whitespace-nowrap"
          >
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
            <div className="mb-6 pb-6 border-b border-gray-200">
              <div className="flex items-center space-x-3 mb-4">
                <span className="px-3 py-1 bg-brand-nude/50 text-brand-espresso rounded-full text-sm font-semibold whitespace-nowrap">
                  {article.category}
                </span>
            ...
            {!showFeedback ? (
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-6 border-2 border-brand-espresso text-brand-espresso hover:bg-brand-espresso hover:text-white rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                ...
                {wasHelpful ? (
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-brand-nude/50 rounded-full mx-auto mb-4">
                      <i className="ri-check-line text-3xl text-brand-espresso"></i>
                    </div>
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-brand-nude/50 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-brand-espresso"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
                    ...
                    <Link
                      href="/support/ticket"
                      className="inline-block bg-brand-espresso hover:bg-brand-cocoa text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                    >
                      Contact Support
                    </Link>
                  </>
              ...
              {relatedArticles.map((related) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <i className="ri-file-text-line text-xl text-brand-espresso"></i>
                    <div>
