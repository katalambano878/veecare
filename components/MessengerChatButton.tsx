  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 right-4 lg:bottom-6 lg:right-6 w-16 h-16 bg-gradient-to-br from-brand-espresso to-brand-cocoa text-white rounded-full shadow-2xl hover:scale-110 transition-transform z-[90] flex items-center justify-center"
      >
        {isOpen ? (
      ...
      {isOpen && (
        <div className="fixed bottom-40 right-4 left-4 sm:left-auto sm:right-6 sm:w-96 h-[min(600px,calc(100dvh-11rem))] bg-white rounded-2xl shadow-2xl z-[90] flex flex-col overflow-hidden border border-gray-200">
          <div className="bg-gradient-to-r from-brand-espresso to-brand-cocoa text-white p-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-12 h-12 flex items-center justify-center bg-white text-brand-espresso rounded-full font-bold text-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-brand-nude/90">Typically replies instantly</p>
              </div>
              <button
              ...
              >
                <div className={`max-w-[75%] ${msg.sender === 'user' ? 'order-2' : 'order-1'}`}>
                  <div className={`px-4 py-2 rounded-2xl ${
                    msg.sender === 'user'
                      ? 'bg-brand-espresso text-white rounded-br-sm'
          ...
          <div className="border-t border-gray-200 p-3 bg-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-brand-mauve/40"
              />
              <button
                onClick={handleSendMessage}
                className="w-9 h-9 flex items-center justify-center bg-brand-espresso hover:bg-brand-cocoa text-white rounded-full transition-colors"
              >
