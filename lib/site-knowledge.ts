...
export const SITE_KNOWLEDGE: SiteKnowledgeEntry[] = [
    ...
    },
    {
        ...
        path: '/checkout',
        category: 'payment',
        content: 'Checkout uses Moolre for secure Mobile Money (MoMo) payments in Ghana Cedis (GHS). Guest checkout is supported — no account needed. We do not accept payment on delivery.',
        keywords: ['pay', 'payment', 'card', 'momo', 'mobile money', 'moolre', 'guest checkout', 'how to pay', 'cod', 'cash on delivery'],
    },
    {
        id: 'shop',
